...
\r\f \v\uFEFF`];function Ei(e,n,t){var r=e==null?"":""+e;if(n&&(r=r?r+" "+n:n),t){for(var o in t)if(t[o])r=r?r+" "+o:o;else if(r.length)for(var s=o.length,a=0;(a=r.indexOf(o,a))>=0;){var c=a+s;(a===0||Er.includes(r[a-1]))&&(c===r.length||Er.includes(r[c]))?r=(a===0?"":r.substring(0,a))+r.substring(c+1):a=c}}return r===""?null:r}function Rr(e,n=!1){var t=n?" !important;":";",r="";for(var o in e){var s=e[o];s!=null&&s!==""&&(r+=" "+o+": "+s+t)}return r}function Rt(e){return e[0]!=="-"||e[1]!=="-"?e.toLowerCase():e}function Ri(e,n){if(n){var t="",r,o;if(Array.isArray(n)?(r=n[0],o=n[1]):r=n,e){e=String(e).replaceAll(/\s*\/\*.*?\*\/\s*/g,"").trim();var s=!1,a=0,c=!1,l=[];r&&l.push(...Object.keys(r).map(Rt)),o&&l.push(...Object.keys(o).map(Rt));var f=0,v=-1;const x=e.length;for(var _=0;_<x;_++){var d=e[_];if(c?d==="/"&&e[_-1]==="*"&&(c=!1):s?s===d&&(s=!1):d==="/"&&e[_+1]==="*"?c=!0:d==='"'||d==="'"?s=d:d==="("?a++:d===")"&&a--,!c&&s===!1&&a===0){if(d===":"&&v===-1)v=_;else if(d===";"||_===x-1){if(v!==-1){var h=Rt(e.substring(f,v).trim());if(!l.includes(h)){d!==";"&&_++;var b=e.substring(f,_).trim();t+=" "+b+";"}}f=_+1,v=-1}}}}return r&&(t+=Rr(r)),o&&(t+=Rr(o,!0)),t=t.trim(),t===""?null:t}return e==null?null:String(e)}function Sn(e,n,t,r,o,s){var a=e.__className;if(a!==t||a===void 0){var c=Ei(t,r,s);c==null?e.removeAttribute("class"):n?e.className=c:e.setAttribute("class",c),e.__className=t}else if(s&&o!==s)for(var l in s){var f=!!s[l];(o==null||f!==!!o[l])&&e.classList.toggle(l,f)}return s}function Ft(e,n={},t,r){for(var o in t){var s=t[o];n[o]!==s&&(t[o]==null?e.style.removeProperty(o):e.style.setProperty(o,s,r))}}function Jt(e,n,t,r){var o=e.__style;if(o!==n){var s=Ri(n,r);s==null?e.removeAttribute("style"):e.style.cssText=s,e.__style=n}else r&&(Array.isArray(r)?(Ft(e,t==null?void 0:t[0],r[0]),Ft(e,t==null?void 0:t[1],r[1],"important")):Ft(e,t,r));return r}const xn=Symbol("class"),Rn=Symbol("style"),co=Symbol("is custom element"),fo=Symbol("is html");function Fi(e,n){n?e.hasAttribute("selected")||e.setAttribute("selected",""):e.removeAttribute("selected")}function nt(e,n,t,r){var o=uo(e);o[n]!==(o[n]=t)&&(n==="loading"&&(e[us]=t),t==null?e.removeAttribute(n):typeof t!="string"&&_o(e).includes(n)?e[n]=t:e.setAttribute(n,t))}function xi(e,n,t,r,o=!1){var s=uo(e),a=s[co],c=!s[fo],l=n||{},f=e.tagName==="OPTION";for(var v in n)v in t||(t[v]=null);t.class?t.class=lo(t.class):t.class=null,t[Rn]&&(t.style??(t.style=null));var _=_o(e);for(const T in t){let p=t[T];if(f&&T==="value"&&p==null){e.value=e.__value="",l[T]=p;continue}if(T==="class"){var d=e.namespaceURI==="http://www.w3.org/1999/xhtml";Sn(e,d,p,r,n==null?void 0:n[xn],t[xn]),l[T]=p,l[xn]=t[xn];continue}if(T==="style"){Jt(e,p,n==null?void 0:n[Rn],t[Rn]),l[T]=p,l[Rn]=t[Rn];continue}var h=l[T];if(p!==h){l[T]=p;var b=T[0]+T[1];if(b!=="$$")if(b==="on"){const y={},V="$$"+T;let M=T.slice(2);var x=ri(M);if(ni(M)&&(M=M.slice(0,-7),y.capture=!0),!x&&h){if(p!=null)continue;e.removeEventListener(M,l[V],y),l[V]=null}if(p!=null)if(x)e[`__${M}`]=p,_t([M]);else{let I=function(X){l[T].call(this,X)};var L=I;l[V]=di(M,e,I,y)}else x&&(e[`__${M}`]=void 0)}else if(T==="style")nt(e,T,p);else if(T==="autofocus")li(e,!!p);else if(!a&&(T==="__value"||T==="value"&&p!=null))e.value=e.__value=p;else if(T==="selected"&&f)Fi(e,p);else{var k=T;c||(k=si(k));var B=k==="defaultValue"||k==="defaultChecked";if(p==null&&!a&&!B)if(s[T]=null,k==="value"||k==="checked"){let y=e;const V=n===void 0;if(k==="value"){let M=y.defaultValue;y.removeAttribute(k),y.defaultValue=M,y.value=y.__value=V?M:null}else{let M=y.defaultChecked;y.removeAttribute(k),y.defaultChecked=M,y.checked=V?M:!1}}else e.removeAttribute(T);else B||_.includes(k)&&(a||typeof p!="string")?e[k]=p:typeof p!="function"&&nt(e,k,p)}}}for(let T of Object.getOwnPropertySymbols(t))T.description===Ps&&Di(e,()=>t[T]);return l}function uo(e){return e.__attributes??(e.__attributes={[co]:e.nodeName.includes("-"),[fo]:e.namespaceURI===As})}var Fr=new Map;function _o(e){var n=Fr.get(e.nodeName);if(n)return n;Fr.set(e.nodeName,n=[]);for(var t,r=e,o=Element.prototype;o!==r;){t=Cr(r);for(var s in t)t[s].set&&n.push(s);r=Bt(r)}return n}function Mi(e,n,t=n){var r=An();fi(e,"input",o=>{var s=o?e.defaultValue:e.value;if(s=xt(e)?Mt(s):s,t(s),r&&s!==(s=n())){var a=e.selectionStart,c=e.selectionEnd;e.value=s??"",c!==null&&(e.selectionStart=a,e.selectionEnd=Math.min(c,e.value.length))}}),kn(n)==null&&e.value&&t(xt(e)?Mt(e.value):e.value),lt(()=>{var o=n();xt(e)&&o===Mt(e.value)||e.type==="date"&&!o&&!e.value||o!==e.value&&(e.value=o??"")})}function xt(e){var n=e.type;return n==="number"||n==="range"}function Mt(e){return e===""?null:+e}function mo(e=!1){const n=K,t=n.l.u;if(!t)return;let r=()=>At(n.s);if(e){let o=0,s={};const a=fn(()=>{let c=!1;const l=n.s;for(const f in l)l[f]!==s[f]&&(s[f]=l[f],c=!0);return c&&o++,o});r=()=>E(a)}t.b.length&&qs(()=>{xr(n,r),Tt(t.b)}),hr(()=>{const o=kn(()=>t.m.map(ls));return()=>{for(const s of o)typeof s=="function"&&s()}}),t.a.length&&hr(()=>{xr(n,r),Tt(t.a)})}function xr(e,n){if(e.l.s)for(const t of e.l.s)E(t);n()}let $n=!1;function Ni(e){var n=$n;try{return $n=!1,[e(),$n]}finally{$n=n}}const Ti={get(e,n){if(!e.exclude.includes(n))return E(e.version),n in e.special?e.special[n]():e.props[n]},set(e,n,t){return n in e.special||(e.special[n]=Ke({get[n](){return e.props[n]}},n,Br)),e.special[n](t),pr(e.version),!0},getOwnPropertyDescriptor(e,n){if(!e.exclude.includes(n)&&n in e.props)return{enumerable:!0,configurable:!0,value:e.props[n]}},deleteProperty(e,n){return e.exclude.includes(n)||(e.exclude.push(n),pr(e.version)),!0},has(e,n){return e.exclude.includes(n)?!1:n in e.props},ownKeys(e){return Reflect.ownKeys(e.props).filter(n=>!e.exclude.includes(n))}};function tt(e,n){return new Proxy({props:e,exclude:n,special:{},version:dn(0)},Ti)}const ki={get(e,n){let t=e.props.length;for(;t--;){let r=e.props[t];if(En(r)&&(r=r()),typeof r=="object"&&r!==null&&n in r)return r[n]}},set(e,n,t){let r=e.props.length;for(;r--;){let o=e.props[r];En(o)&&(o=o());const s=Xe(o,n);if(s&&s.set)return s.set(t),!0}return!1},getOwnPropertyDescriptor(e,n){let t=e.props.length;for(;t--;){let r=e.props[t];if(En(r)&&(r=r()),typeof r=="object"&&r!==null&&n in r){const o=Xe(r,n);return o&&!o.configurable&&(o.configurable=!0),o}}},has(e,n){if(n===nn||n===Ir)return!1;for(let t of e.props)if(En(t)&&(t=t()),t!=null&&n in t)return!0;return!1},ownKeys(e){const n=[];for(let t of e.props)if(En(t)&&(t=t()),!!t){for(const r in t)n.includes(r)||n.push(r);for(const r of Object.getOwnPropertySymbols(t))n.includes(r)||n.push(r)}return n}};function Si(...e){return new Proxy({props:e},ki)}function Mr(e){var n;return((n=e.ctx)==null?void 0:n.d)??!1}function Ke(e,n,t,r){var V;var o=(t&Ms)!==0,s=!Cn||(t&Ns)!==0,a=(t&Ts)!==0,c=(t&ks)!==0,l=!1,f;a?[f,l]=Ni(()=>e[n]):f=e[n];var v=nn in e||Ir in e,_=a&&(((V=Xe(e,n))==null?void 0:V.set)??(v&&n in e&&(M=>e[n]=M)))||void 0,d=r,h=!0,b=!1,x=()=>(b=!0,h&&(h=!1,c?d=kn(r):d=r),d);f===void 0&&r!==void 0&&(_&&s&&bs(),f=x(),_&&_(f));var k;if(s)k=()=>{var M=e[n];return M===void 0?x():(h=!0,b=!1,M)};else{var B=(o?fn:Ut)(()=>e[n]);B.f|=fs,k=()=>{var M=E(B);return M!==void 0&&(d=void 0),M===void 0?d:M}}if((t&Br)===0)return k;if(_){var L=e.$$legacy;return function(M,I){return arguments.length>0?((!s||!I||L||l)&&_(I?k():M),M):k()}}var T=!1,p=Ht(f),y=fn(()=>{var M=k(),I=E(p);return T?(T=!1,I):p.v=M});return a&&E(y),o||(y.equals=qt),function(M,I){if(arguments.length>0){const X=I?E(y):s&&a?Le(M):M;if(!y.equals(X)){if(T=!0,Z(p,X),b&&d!==void 0&&(d=X),Mr(y))return M;kn(()=>E(y))}return M}return Mr(y)?y.v:E(y)}}function Ci(e,n,{bubbles:t=!1,cancelable:r=!1}={}){return new CustomEvent(e,{detail:n,bubbles:t,cancelable:r})}function Ai(){const e=K;return e===null&&zr(),(n,t,r)=>{var s;const o=(s=e.s.$$events)==null?void 0:s[n];if(o){const a=rt(o)?o.slice():[o],c=Ci(n,t,r);for(const l of a)l.call(e.x,c);return!c.defaultPrevented}return!0}}function Pi(e){K===null&&zr(),K.l===null&&hs(),Ii(K).a.push(e)}function Ii(e){var n=e.l;return n.u??(n.u={a:[],b:[],m:[]})}const Oi="5";var Sr;typeof window<"u"&&((Sr=window.__svelte??(window.__svelte={})).v??(Sr.v=new Set)).add(Oi);const Li={__category__:"External libraries",__dim__:7,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:"error",EnzymeRvs:"error",FiniteDifferences:92.07443365695792,ForwardDiff:1.928539366190861,MooncakeFwd:25.719179285388048,MooncakeRvs:8.441147843597918,ReverseDiff:"error",ReverseDiffCompiled:"error"},Bi={__category__:"Distributions",__dim__:1,DifferFwd:3.1722149622190274,DifferRvs:3.142948124131542,EnzymeFwd:2.004812991914903,EnzymeRvs:1.636598248869503,FiniteDifferences:39.790104307546656,ForwardDiff:2.3759095455191668,MooncakeFwd:4.614927805222794,MooncakeRvs:3.7384039605091854,ReverseDiff:37.409154391328514,ReverseDiffCompiled:6.687749686338781},zi={__category__:"Distributions",__dim__:1,DifferFwd:4.998951106251624,DifferRvs:"error",EnzymeFwd:8.904654115167194,EnzymeRvs:13.91365120836055,FiniteDifferences:31.28483173753872,ForwardDiff:1.3290127914827223,MooncakeFwd:5.991365598727563,MooncakeRvs:9.246244116319556,ReverseDiff:40.872171626849145,ReverseDiffCompiled:5.644742476422212},Vi={__category__:"Distributions",__dim__:10,DifferFwd:32.58373925501433,DifferRvs:"error",EnzymeFwd:5.167305236270754,EnzymeRvs:19.01285221160793,FiniteDifferences:162.20410141107146,ForwardDiff:2.3834960858183547,MooncakeFwd:32.2399589302461,MooncakeRvs:7.523278625110521,ReverseDiff:114.55890152836903,ReverseDiffCompiled:12.612135539118945},qi={__category__:"Distributions",__dim__:2,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:"error",EnzymeRvs:5.722496622455946,FiniteDifferences:42.47256022290411,ForwardDiff:.9289994237885404,MooncakeFwd:18.04516909867324,MooncakeRvs:13.5961029037188,ReverseDiff:22.258528542969017,ReverseDiffCompiled:2.1791351063232898},ji={__category__:"Distributions",__dim__:1,DifferFwd:13.673465311961468,DifferRvs:11.967136497125745,EnzymeFwd:39.77615874490517,EnzymeRvs:6.273980779864685,FiniteDifferences:429.4360043291779,ForwardDiff:9.318985994424233,MooncakeFwd:32.027880846305635,MooncakeRvs:10.425422843272308,ReverseDiff:709.2135934846336,ReverseDiffCompiled:82.89410604745626},$i={__category__:"Core Turing syntax",__dim__:2,DifferFwd:15.222862865461037,DifferRvs:9.973528485560859,EnzymeFwd:34.294441915197346,EnzymeRvs:5.2586803517964364,FiniteDifferences:607.5158397166942,ForwardDiff:11.98975467861096,MooncakeFwd:64.42478957312471,MooncakeRvs:19.19661927702243,ReverseDiff:1140.9734225695383,ReverseDiffCompiled:114.76717376255702},Ui={__category__:"Distributions",__dim__:3,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:23.700310900655282,EnzymeRvs:35.33706639945772,FiniteDifferences:54.02956257411521,ForwardDiff:.9181570495745751,MooncakeFwd:"error",MooncakeRvs:"error",ReverseDiff:72.62906951674007,ReverseDiffCompiled:4.933660451422964},Hi={__category__:"Core Turing syntax",__dim__:2,DifferFwd:7.227270662951763,DifferRvs:"error",EnzymeFwd:3.712494553972063,EnzymeRvs:1.3264904753581008,FiniteDifferences:72.58532857870607,ForwardDiff:1.6598102343018994,MooncakeFwd:9.906593871677671,MooncakeRvs:5.46832796519184,ReverseDiff:223.33168165100122,ReverseDiffCompiled:20.60892638859903},Gi={__category__:"Base Julia features",__dim__:2,DifferFwd:10.747768549347708,DifferRvs:16.701505749676382,EnzymeFwd:20.292485185005372,EnzymeRvs:3.5740118852247003,FiniteDifferences:394.16099595643146,ForwardDiff:7.299525598762661,MooncakeFwd:39.71844363336545,MooncakeRvs:13.29997528335439,ReverseDiff:624.3519347675731,ReverseDiffCompiled:81.0938199487839},Ki={__category__:"External libraries",__dim__:5,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:"wrong",EnzymeRvs:"error",FiniteDifferences:64.63914657869252,ForwardDiff:1.1561099532780295,MooncakeFwd:"error",MooncakeRvs:9.896523301349768,ReverseDiff:"error",ReverseDiffCompiled:"error"},Xi={__category__:"DynamicPPL demo models",__dim__:2,DifferFwd:6.762409078340753,DifferRvs:"error",EnzymeFwd:3.3788918985471557,EnzymeRvs:1.2513490105714813,FiniteDifferences:67.21659867414584,ForwardDiff:2.470724241092127,MooncakeFwd:9.450669468911611,MooncakeRvs:4.817744239582417,ReverseDiff:210.09490435077026,ReverseDiffCompiled:19.658593086461696},Wi={__category__:"DynamicPPL demo models",__dim__:2,DifferFwd:8.408333668852185,DifferRvs:"error",EnzymeFwd:4.4216458395010845,EnzymeRvs:1.5069184277253285,FiniteDifferences:90.30533073797083,ForwardDiff:2.8851964935410934,MooncakeFwd:13.06593905597762,MooncakeRvs:8.081408719630886,ReverseDiff:253.7408594044478,ReverseDiffCompiled:28.216410502173687},Ji={__category__:"DynamicPPL demo models",__dim__:4,DifferFwd:17.180791884816752,DifferRvs:"error",EnzymeFwd:8.549744519464893,EnzymeRvs:28.659242099439872,FiniteDifferences:94.43310525048999,ForwardDiff:2.112253713989072,MooncakeFwd:12.523738383393452,MooncakeRvs:4.215743819193251,ReverseDiff:128.11789196128092,ReverseDiffCompiled:14.586582707677406},Yi={__category__:"DynamicPPL demo models",__dim__:4,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:10.579121218357686,EnzymeRvs:17.374415029888983,FiniteDifferences:79.9809957266442,ForwardDiff:1.4223191341057642,MooncakeFwd:17.862070145423438,MooncakeRvs:7.6213800272631875,ReverseDiff:91.64265129682997,ReverseDiffCompiled:8.788946775232311},Zi={__category__:"DynamicPPL demo models",__dim__:4,DifferFwd:13.738707008126287,DifferRvs:"error",EnzymeFwd:17.66704074728104,EnzymeRvs:26.132547074135424,FiniteDifferences:97.89505014791831,ForwardDiff:1.575730199613651,MooncakeFwd:17.119110401253636,MooncakeRvs:7.047334266446112,ReverseDiff:130.72702843920283,ReverseDiffCompiled:11.635939901982681},Qi={__category__:"DynamicPPL demo models",__dim__:4,DifferFwd:9.814978151260503,DifferRvs:"error",EnzymeFwd:7.292860526493877,EnzymeRvs:9.484985422740527,FiniteDifferences:84.14205547761587,ForwardDiff:1.4224863864341621,MooncakeFwd:12.082248956543086,MooncakeRvs:5.015830853938896,ReverseDiff:62.86557982159335,ReverseDiffCompiled:10.12622737296003},ea={__category__:"DynamicPPL demo models",__dim__:2,DifferFwd:8.69527664854068,DifferRvs:"error",EnzymeFwd:5.226332992774225,EnzymeRvs:1.7550590025005604,FiniteDifferences:102.07271717545692,ForwardDiff:1.9959308889620866,MooncakeFwd:12.357992435274175,MooncakeRvs:5.773575111298808,ReverseDiff:360.3337623372791,ReverseDiffCompiled:32.74324036380356},na={__category__:"DynamicPPL demo models",__dim__:4,DifferFwd:26.59210022953328,DifferRvs:"error",EnzymeFwd:8.242388059701494,EnzymeRvs:10.517498699947998,FiniteDifferences:82.20021720852017,ForwardDiff:1.7450803675626905,MooncakeFwd:14.011181039859387,MooncakeRvs:5.065632051941882,ReverseDiff:132.19203545904344,ReverseDiffCompiled:13.29773027638913},ta={__category__:"DynamicPPL demo models",__dim__:4,DifferFwd:35.46787485040178,DifferRvs:"error",EnzymeFwd:16.517586080522154,EnzymeRvs:27.523066960089864,FiniteDifferences:102.72783823091345,ForwardDiff:1.6525425308995612,MooncakeFwd:19.35873674971305,MooncakeRvs:8.988158418468887,ReverseDiff:160.36647359454852,ReverseDiffCompiled:12.323266331658292},ra={__category__:"DynamicPPL demo models",__dim__:4,DifferFwd:32.60886316435382,DifferRvs:"error",EnzymeFwd:12.232749067754874,EnzymeRvs:16.854364867272402,FiniteDifferences:113.27450639599554,ForwardDiff:2.4742937114945875,MooncakeFwd:16.912261945446676,MooncakeRvs:6.397296248087506,ReverseDiff:191.37568735271014,ReverseDiffCompiled:14.196828327214126},oa={__category__:"DynamicPPL demo models",__dim__:4,DifferFwd:26.63978626060839,DifferRvs:"error",EnzymeFwd:8.697564586050119,EnzymeRvs:9.764313077707097,FiniteDifferences:86.66204888998001,ForwardDiff:1.690443231792959,MooncakeFwd:13.828266752775471,MooncakeRvs:4.920576745982236,ReverseDiff:135.23713770628208,ReverseDiffCompiled:14.267451753475823},sa={__category__:"DynamicPPL demo models",__dim__:4,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:12.545359148147474,EnzymeRvs:20.504775776159445,FiniteDifferences:82.52124441883912,ForwardDiff:1.5307851103313925,MooncakeFwd:19.738815409077766,MooncakeRvs:8.22158670110218,ReverseDiff:89.60550148434857,ReverseDiffCompiled:10.623319177707547},ia={__category__:"DynamicPPL demo models",__dim__:4,DifferFwd:29.2651303624834,DifferRvs:"error",EnzymeFwd:13.49165746506408,EnzymeRvs:21.406269730563103,FiniteDifferences:84.61707143248725,ForwardDiff:1.558311925561413,MooncakeFwd:17.13700249651928,MooncakeRvs:6.97183812265175,ReverseDiff:99.07487569464756,ReverseDiffCompiled:10.554817027632561},aa={__category__:"Core Turing syntax",__dim__:5,DifferFwd:16.95784871669242,DifferRvs:"error",EnzymeFwd:2.534112814393244,EnzymeRvs:.805003758727413,FiniteDifferences:155.0665968551016,ForwardDiff:2.414622431633829,MooncakeFwd:12.986192663719258,MooncakeRvs:2.7469723548559584,ReverseDiff:146.0187876271538,ReverseDiffCompiled:19.55392141271366},la={__category__:"Core Turing syntax",__dim__:1,DifferFwd:6.687861872898103,DifferRvs:"error",EnzymeFwd:7.939497327896509,EnzymeRvs:2.4059606104082434,FiniteDifferences:92.62894955654103,ForwardDiff:3.256469009269012,MooncakeFwd:11.065102390482686,MooncakeRvs:11.116410562904013,ReverseDiff:449.673255975542,ReverseDiffCompiled:55.7552927096985},ca={__category__:"DynamicPPL arXiV paper",__dim__:2,DifferFwd:7.1471381698869845,DifferRvs:"error",EnzymeFwd:3.937054425317336,EnzymeRvs:3.4277170550628995,FiniteDifferences:21.427576914439705,ForwardDiff:2.68905414826865,MooncakeFwd:1.9147884084636613,MooncakeRvs:.5265714992403095,ReverseDiff:1253.1018281535648,ReverseDiffCompiled:203.85388619637408},fa={__category__:"DynamicPPL arXiV paper",__dim__:13,DifferFwd:31.126578060790045,DifferRvs:"error",EnzymeFwd:5.294691944808996,EnzymeRvs:2.2759761747187293,FiniteDifferences:174.1030640668524,ForwardDiff:5.422940303255222,MooncakeFwd:29.284280222127297,MooncakeRvs:7.669837578832399,ReverseDiff:99.81519983433422,ReverseDiffCompiled:10.72715363098821},da={__category__:"DynamicPPL arXiV paper",__dim__:1e4,DifferFwd:23502.74955454365,DifferRvs:"error",EnzymeFwd:35024.4595922299,EnzymeRvs:8.431650408647508,FiniteDifferences:182619.51101801428,ForwardDiff:52739.29466431662,MooncakeFwd:6652.149902435953,MooncakeRvs:1.3166165934827827,ReverseDiff:363.2052771594549,ReverseDiffCompiled:112.01268814529169},ua={__category__:"DynamicPPL arXiV paper",__dim__:115,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:"error",EnzymeRvs:11.99373278723254,FiniteDifferences:"NaN",ForwardDiff:24.25345175916357,MooncakeFwd:4222.2479934855955,MooncakeRvs:6.746721628462945,ReverseDiff:65.12258084738629,ReverseDiffCompiled:11.939888490296928},_a={__category__:"DynamicPPL arXiV paper",__dim__:535,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:265.8546674385592,EnzymeRvs:2.827812337634982,FiniteDifferences:7358.258380503145,ForwardDiff:403.30151913482507,MooncakeFwd:1498.9103813773486,MooncakeRvs:11.6310281736233,ReverseDiff:188.31638345828603,ReverseDiffCompiled:34.936314236919735},ma={__category__:"DynamicPPL arXiV paper",__dim__:100,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:45.080372383887905,EnzymeRvs:3.3124129846777164,FiniteDifferences:1111.715569923695,ForwardDiff:87.10811615975689,MooncakeFwd:"error",MooncakeRvs:"error",ReverseDiff:64.06259152319416,ReverseDiffCompiled:12.752930908018048},va={__category__:"DynamicPPL arXiV paper",__dim__:400,DifferFwd:1412.126056568986,DifferRvs:"error",EnzymeFwd:588.9067359344076,EnzymeRvs:1.8168160124671278,FiniteDifferences:6090.84320934849,ForwardDiff:266.0004704673045,MooncakeFwd:627.6924794282886,MooncakeRvs:6.543347137074725,ReverseDiff:293.1909703124187,ReverseDiffCompiled:49.256231915706714},pa={__category__:"DynamicPPL arXiV paper",__dim__:503,DifferFwd:1796.3680655775559,DifferRvs:"error",EnzymeFwd:86.6766826923077,EnzymeRvs:3.3583627626932206,FiniteDifferences:6010.036631310496,ForwardDiff:115.73043430335098,MooncakeFwd:786.9261521537749,MooncakeRvs:3.192301141202521,ReverseDiff:222.48992097125188,ReverseDiffCompiled:31.87946528869917},ga={__category__:"Core Turing syntax",__dim__:2,DifferFwd:9.05411728991511,DifferRvs:4.456173635576232,EnzymeFwd:3.9814447204398764,EnzymeRvs:2.621784505071316,FiniteDifferences:83.31937138563075,ForwardDiff:2.1530040718555985,MooncakeFwd:12.156039963354802,MooncakeRvs:5.800404579014094,ReverseDiff:156.0584023981661,ReverseDiffCompiled:17.076963865268237},ha={__category__:"External libraries",__dim__:20,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:"error",EnzymeRvs:18.116872277718368,FiniteDifferences:232.53357091518927,ForwardDiff:3.3016546203930472,MooncakeFwd:"error",MooncakeRvs:"error",ReverseDiff:52.954284705674695,ReverseDiffCompiled:"wrong"},ba={__category__:"Core Turing syntax",__dim__:4,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:3.4787547098833222,EnzymeRvs:4.1616575591985425,FiniteDifferences:60.08108108108109,ForwardDiff:1.1860642979819667,MooncakeFwd:15.753440934746015,MooncakeRvs:6.006172158095558,ReverseDiff:39.3960258780037,ReverseDiffCompiled:3.778699970498574},ya={__category__:"Effect of model size",__dim__:10,DifferFwd:28.430816642089134,DifferRvs:"error",EnzymeFwd:2.2586339628331857,EnzymeRvs:.8949442640101816,FiniteDifferences:238.59301770170174,ForwardDiff:1.7957115237661758,MooncakeFwd:18.568268515411884,MooncakeRvs:1.9194707443495926,ReverseDiff:96.96974366949907,ReverseDiffCompiled:19.885052268258526},Da={__category__:"Effect of model size",__dim__:50,DifferFwd:134.91978864837225,DifferRvs:"error",EnzymeFwd:8.004386267873178,EnzymeRvs:.5958598123393829,FiniteDifferences:718.9821666951908,ForwardDiff:18.444026662109042,MooncakeFwd:49.11702459841099,MooncakeRvs:1.4575880123223588,ReverseDiff:151.3820810453882,ReverseDiffCompiled:22.18260445002441},wa={__category__:"Effect of model size",__dim__:100,DifferFwd:267.847489150651,DifferRvs:"error",EnzymeFwd:16.821386205727844,EnzymeRvs:.6199065608902522,FiniteDifferences:1267.1752099216526,ForwardDiff:19.226568444352218,MooncakeFwd:88.61844098609006,MooncakeRvs:1.4389856274184634,ReverseDiff:143.03360420968494,ReverseDiffCompiled:24.026986971806718},Ea={__category__:"Effect of model size",__dim__:500,DifferFwd:1310.8430202283193,DifferRvs:"error",EnzymeFwd:127.7817820305704,EnzymeRvs:.9531236664675259,FiniteDifferences:5948.724199169012,ForwardDiff:85.0429268292683,MooncakeFwd:384.6443228173749,MooncakeRvs:1.7496355964710393,ReverseDiff:134.17533170321082,ReverseDiffCompiled:23.15639662183297},Ra={__category__:"Distributions",__dim__:1,DifferFwd:3.7922840125897,DifferRvs:"error",EnzymeFwd:2.758044083537255,EnzymeRvs:2.64372247660621,FiniteDifferences:27.46507856300681,ForwardDiff:1.6774920672118128,MooncakeFwd:4.424270766696814,MooncakeRvs:4.56976105744789,ReverseDiff:70.50102780117945,ReverseDiffCompiled:7.883604491550215},Fa={__category__:"Distributions",__dim__:1,DifferFwd:3.8106707629288272,DifferRvs:"error",EnzymeFwd:1.8351655929231434,EnzymeRvs:7.337994151040771,FiniteDifferences:19.12284281514785,ForwardDiff:1.1541845259238794,MooncakeFwd:4.065073565715414,MooncakeRvs:8.74388458966275,ReverseDiff:23.811861010933654,ReverseDiffCompiled:5.044581692070561},xa={__category__:"Core Turing syntax",__dim__:1,DifferFwd:6.912162054155205,DifferRvs:"error",EnzymeFwd:8.882151370842974,EnzymeRvs:1.8406027535571987,FiniteDifferences:97.46784664380206,ForwardDiff:2.529853978630394,MooncakeFwd:10.943382472276662,MooncakeRvs:10.590733767593521,ReverseDiff:522.4105191495304,ReverseDiffCompiled:52.956405097250176},Ma={__category__:"Core Turing syntax",__dim__:1,DifferFwd:14.68091009988901,DifferRvs:12.698850125291333,EnzymeFwd:34.89264961307836,EnzymeRvs:7.432600772983989,FiniteDifferences:464.5891014762136,ForwardDiff:12.465127298396654,MooncakeFwd:38.48178857723564,MooncakeRvs:10.665113780651355,ReverseDiff:1432.4028801890254,ReverseDiffCompiled:131.00187206942402},Na={__category__:"Core Turing syntax",__dim__:3,DifferFwd:13.46378326821842,DifferRvs:"error",EnzymeFwd:2.6416517220766083,EnzymeRvs:14.716792981370729,FiniteDifferences:88.07271410839884,ForwardDiff:1.3871677470392914,MooncakeFwd:9.259307368204706,MooncakeRvs:2.8570595229889015,ReverseDiff:119.47244094488188,ReverseDiffCompiled:15.150623831937427},Ta={__category__:"Core Turing syntax",__dim__:1,DifferFwd:15.890475241491119,DifferRvs:13.786761862338974,EnzymeFwd:44.975814135167724,EnzymeRvs:7.413146825045136,FiniteDifferences:456.4279399657179,ForwardDiff:12.489304140594783,MooncakeFwd:34.45650068561516,MooncakeRvs:11.947507890694888,ReverseDiff:1194.8621121414876,ReverseDiffCompiled:131.59432558616797},ka={__category__:"Distributions",__dim__:1,DifferFwd:4.111259835481305,DifferRvs:3.9721205438574194,EnzymeFwd:3.36071278468896,EnzymeRvs:3.037619047619047,FiniteDifferences:26.765458077047587,ForwardDiff:"NaN",MooncakeFwd:4.906645971374411,MooncakeRvs:3.754441370989157,ReverseDiff:"NaN",ReverseDiffCompiled:6.526996745832382},Sa={__category__:"External libraries",__dim__:5,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:"wrong",EnzymeRvs:277.3016997719343,FiniteDifferences:58.68237325410911,ForwardDiff:7.463738150040963,MooncakeFwd:"error",MooncakeRvs:6.774777860227943,ReverseDiff:"error",ReverseDiffCompiled:"error"},Ca={__category__:"PosteriorDB",__dim__:4,DifferFwd:12.250207912557919,DifferRvs:"error",EnzymeFwd:3.1098639942734425,EnzymeRvs:3.7918396055062176,FiniteDifferences:56.37316901789093,ForwardDiff:3.814635891930578,MooncakeFwd:10.657894736842104,MooncakeRvs:11.937331136738056,ReverseDiff:426.7386042544117,ReverseDiffCompiled:62.87771520514884},Aa={__category__:"PosteriorDB",__dim__:3,DifferFwd:21.84086956521739,DifferRvs:"error",EnzymeFwd:9.144436256448047,EnzymeRvs:11.344102443609021,FiniteDifferences:39.25427839913758,ForwardDiff:2.765974832488969,MooncakeFwd:8.125129480008287,MooncakeRvs:29.82328418912049,ReverseDiff:677.9228632129433,ReverseDiffCompiled:156.4693036670787},Pa={__category__:"PosteriorDB",__dim__:4,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:6.708494334926976,EnzymeRvs:7.5007995735607675,FiniteDifferences:49.85295875672445,ForwardDiff:2.4677114593753475,MooncakeFwd:8.325289135779983,MooncakeRvs:22.930144687125612,ReverseDiff:421.0799258801729,ReverseDiffCompiled:82.78762333556854},Ia={__category__:"PosteriorDB",__dim__:10,DifferFwd:28.933539717639054,DifferRvs:"error",EnzymeFwd:5.377841709927206,EnzymeRvs:2.783529500760006,FiniteDifferences:225.13842678168004,ForwardDiff:3.887562758027755,MooncakeFwd:33.71441765007696,MooncakeRvs:5.569384541658109,ReverseDiff:230.86583774129284,ReverseDiffCompiled:28.15777853842204},Oa={__category__:"PosteriorDB",__dim__:10,DifferFwd:32.27080857749427,DifferRvs:"error",EnzymeFwd:5.980266526567317,EnzymeRvs:2.8983784603818825,FiniteDifferences:263.46857321348,ForwardDiff:6.807958177902823,MooncakeFwd:38.01584764023076,MooncakeRvs:6.001687481158382,ReverseDiff:299.7169132347061,ReverseDiffCompiled:31.479251736292888},La={__category__:"PosteriorDB",__dim__:4,DifferFwd:6.621305160379877,DifferRvs:"error",EnzymeFwd:1.257652183881692,EnzymeRvs:1.813907259451814,FiniteDifferences:50.32436974789916,ForwardDiff:2.34018099201955,MooncakeFwd:6.80528178393394,MooncakeRvs:4.1501768800639045,ReverseDiff:243.13119066681918,ReverseDiffCompiled:31.908976269632003},Ba={__category__:"PosteriorDB",__dim__:3,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:6.384640858363413,EnzymeRvs:10.20395211308236,FiniteDifferences:38.395598637673565,ForwardDiff:2.795703477868112,MooncakeFwd:7.784972170686457,MooncakeRvs:23.21293225959261,ReverseDiff:323.1361837906829,ReverseDiffCompiled:68.64265519360787},za={__category__:"PosteriorDB",__dim__:90,DifferFwd:206.38256286373118,DifferRvs:"error",EnzymeFwd:38.58529969157594,EnzymeRvs:2.5571867655035256,FiniteDifferences:1060.4330470212533,ForwardDiff:42.00835095710645,MooncakeFwd:153.31856683867198,MooncakeRvs:11.086275848614903,ReverseDiff:408.6660702667534,ReverseDiffCompiled:55.84935156328542},Va={__category__:"PosteriorDB",__dim__:65,DifferFwd:148.74382277281342,DifferRvs:"error",EnzymeFwd:28.03624532064514,EnzymeRvs:2.5246827712560225,FiniteDifferences:868.3729324837311,ForwardDiff:34.58900220796972,MooncakeFwd:138.28073902519722,MooncakeRvs:5.989659538548115,ReverseDiff:352.4302682127374,ReverseDiffCompiled:48.36983854586208},qa={__category__:"PosteriorDB",__dim__:6,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:7.197046644269084,EnzymeRvs:6.093329371191321,FiniteDifferences:116.87104393008975,ForwardDiff:8.84458431080849,MooncakeFwd:"error",MooncakeRvs:"error",ReverseDiff:238.20273518884554,ReverseDiffCompiled:49.32771919892435},ja={__category__:"PosteriorDB",__dim__:6,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:8.555163914875573,EnzymeRvs:6.110352329233185,FiniteDifferences:110.92508606708964,ForwardDiff:8.152197895934034,MooncakeFwd:"error",MooncakeRvs:"error",ReverseDiff:233.63596168017685,ReverseDiffCompiled:43.37642928067644},$a={__category__:"Base Julia features",__dim__:50,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:35.05753005779422,EnzymeRvs:11.977007393955118,FiniteDifferences:855.3113768409673,ForwardDiff:3.47300357268656,MooncakeFwd:172.54729986297073,MooncakeRvs:"error",ReverseDiff:"error",ReverseDiffCompiled:"error"},Ua={__category__:"Base Julia features",__dim__:1,DifferFwd:"error",DifferRvs:"error",EnzymeFwd:5.519436690137911,EnzymeRvs:15.386958551641852,FiniteDifferences:10.776344341404961,ForwardDiff:.9394515223493846,MooncakeFwd:5.897081623827956,MooncakeRvs:"error",ReverseDiff:"error",ReverseDiffCompiled:"error"},Ha={abstractgps:Li,assume_beta:Bi,assume_dirichlet:zi,assume_lkjcholu:Vi,assume_mvnormal:qi,assume_normal:ji,assume_submodel:$i,assume_wishart:Ui,broadcast_macro:Hi,control_flow:Gi,delaydiffeq:Ki,demo_assume_dot_observe:Xi,demo_assume_dot_observe_literal:Wi,demo_assume_index_observe:Ji,demo_assume_matrix_observe_matrix_index:Yi,demo_assume_multivariate_observe:Zi,demo_assume_multivariate_observe_literal:Qi,demo_assume_observe_literal:ea,demo_assume_submodel_observe_index_literal:na,demo_dot_assume_observe:ta,demo_dot_assume_observe_index:ra,demo_dot_assume_observe_index_literal:oa,demo_dot_assume_observe_matrix_index:sa,demo_dot_assume_observe_submodel:ia,dot_assume:aa,dot_observe:la,dppl_gauss_unknown:ca,dppl_hier_poisson:fa,dppl_high_dim_gauss:da,dppl_hmm_semisup:ua,dppl_lda:_a,dppl_logistic_regression:ma,dppl_naive_bayes:va,dppl_sto_volatility:pa,dynamic_constraint:ga,lux_nn:ha,multiple_constraints_same_var:ba,n010:ya,n050:Da,n100:wa,n500:Ea,observe_bernoulli:Ra,observe_categorical:Fa,observe_index:xa,observe_literal:Ma,observe_multivariate:Na,observe_submodel:Ta,observe_von_mises:ka,ordinarydiffeq:Sa,pdb_arma11:Ca,pdb_earnings:Aa,pdb_earnings_male:Pa,pdb_eightsch_centered:Ia,pdb_eightsch_noncentered:Oa,pdb_garch11:La,pdb_kidiq:Ba,pdb_radon:za,pdb_rats:Va,pdb_sblrc:qa,pdb_sblri:ja,threaded_assume:$a,threaded_observe:Ua},Ga=`#=
